...
// $ javac -d classes packages/packagea/InputImports.java ImportsAndPackagesII.java
// $ java -cp classes ImportsAndPackagesII

// $ java --class-path "classes:libs/gson-2.8.6.jar" ImportsAndPackagesII         (DON'T COMPILE JAR, JUST RUN)
...
// $ export CLASSPATH="/home/moacir/Development/CODE_LAB/java/1Z0-815/ImportsAndPackagesII/libs/gson-2.8.6.jar"
// $ javac -d classes -classpath $CLASSPATH packages/packagea/InputImports.java ImportsAndPackagesII.java
// $ java --class-path "classes:libs/*" ImportsAndPackagesII

// CREATE A JAR WITH EXTERNAL LIBRARY AND IMPORT AN OTHER CLASS FROM PROJECT
// $ cd classes
// $ jar --create --verbose --manifest META-INF/MANIFEST.MF --file ImportsAndPackagesII.jar .              (JUST INCLUDE FILES FROM FOLDER)
